...
namespace PufferSoftware.SecureSave
{
    public class SecurePlayerPrefs : ScriptableObject
    {
        ...
        private static byte[] keyArray = Encoding.UTF8.GetBytes("TFzfzkSoTjHDXfQdOG4JNW9TAzvifJQU");
        ...
        {
            PlayerPrefs.SetString(Encrypt(Key), Encrypt(Value.ToString(CultureInfo.CurrentCulture)));
        }
